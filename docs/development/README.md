# Development Logs (업데이트: 2025-12-20)

개발 진행 상황을 날짜별로 모아둔 인덱스입니다.

| 날짜 | 파일 | 주요 내용 |
| --- | --- | --- |
| 2025-12-22 | [2025-12-22.md](2025-12-22.md) | 평가 프롬프트 정확화, 실패 응답 처리 개선, 파싱 안정화 |
| 2025-12-21 | [2025-12-21.md](2025-12-21.md) | 프롬프트 평가 루브릭 분기(reference), 평가 UI 표/리스트 개편, Graphviz 시각화, Swagger 최신화 |
| 2025-12-20 | [2025-12-20.md](2025-12-20.md) | 서비스 리네임(chat_graph/prompt_eval), shared 모델 매핑, 평가 병렬화, 모델 리스트 확장, 네이밍 가이드 추가, Streamlit 평가 UI 개선(width/status 정규화) |
